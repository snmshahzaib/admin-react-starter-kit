...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'filesystems.links./Users/shahzaib/Personal/Projects/herd-backend/public/storage' => 'string',
            ...
            'passport.password_grant_client_id' => 'string',
            'passport.password_grant_client_secret' => 'string',
...
'filesystems.links./Users/shahzaib/Personal/Projects/herd-backend/public/storage','fortify.guard','fortify.middleware','fortify.auth_middleware','fortify.passwords',
...
'fortify.redirects.password-reset','fortify.features','inertia.ssr.enabled','inertia.ssr.url','inertia.ensure_pages_exist',
...
'passport.guard','passport.private_key','passport.public_key','passport.connection','passport.password_grant_client_id',
'passport.password_grant_client_secret','permission.models.permission','permission.models.role','permission.table_names.roles','permission.table_names.permissions',
...
'queue.failed.database','queue.failed.table','scribe.title','scribe.description','scribe.intro_text',
'scribe.base_url','scribe.routes.0.match.prefixes','scribe.routes.0.match.domains','scribe.routes.0.include','scribe.routes.0.exclude',
'scribe.type','scribe.theme','scribe.static.output_path','scribe.laravel.add_routes','scribe.laravel.docs_url',
'scribe.laravel.assets_directory','scribe.laravel.middleware','scribe.external.html_attributes','scribe.try_it_out.enabled','scribe.try_it_out.base_url',
'scribe.try_it_out.use_csrf','scribe.try_it_out.csrf_url','scribe.auth.enabled','scribe.auth.default','scribe.auth.in',
'scribe.auth.name','scribe.auth.use_value','scribe.auth.placeholder','scribe.auth.extra_info','scribe.example_languages',
'scribe.postman.enabled','scribe.postman.overrides','scribe.openapi.enabled','scribe.openapi.overrides','scribe.openapi.generators',
...
'debugbar.theme','debugbar.debug_backtrace_limit','boost.enabled','boost.browser_logs_watcher','log-viewer.enabled',
...
'log-viewer.defaults.folder_sorting_method','log-viewer.defaults.folder_sorting_order','log-viewer.defaults.log_sorting_order','log-viewer.defaults.per_page','log-viewer.defaults.theme',
'log-viewer.defaults.shorter_stack_traces','log-viewer.exclude_ip_from_identifiers','log-viewer.root_folder_prefix','ide-helper.filename','ide-helper.models_filename',
...
'debugbar.cache.delete','debugbar.queries.explain','scribe','scribe.postman','scribe.openapi',
...
'two-factor.regenerate-recovery-codes','passport.token','passport.authorizations.authorize','passport.device','passport.device.code',
...
'home','dashboard','roles.index','roles.create','roles.store',
'roles.show','roles.edit','roles.update','roles.destroy','roles.data',
'permissions.index','permissions.create','permissions.store','permissions.show','permissions.edit',
'permissions.update','permissions.destroy','permissions.data','profile.edit',
...
'app','emails.send-otp','scribe.index','laravel-exceptions-renderer::components.badge','laravel-exceptions-renderer::components.empty-state',
...
'pagination::simple-bootstrap-5','pagination::simple-default','pagination::simple-tailwind','pagination::tailwind','scribe::components.badges.auth',
'scribe::components.badges.base','scribe::components.badges.deprecated','scribe::components.badges.http-method','scribe::components.field-details','scribe::components.nested-fields',
'scribe::external.elements','scribe::external.rapidoc','scribe::external.scalar','scribe::markdown.auth','scribe::markdown.intro',
'scribe::partials.example-requests.bash.md','scribe::partials.example-requests.javascript.md','scribe::partials.example-requests.php.md','scribe::partials.example-requests.python.md','scribe::themes.default.endpoint',
'scribe::themes.default.groups','scribe::themes.default.index','scribe::themes.default.sidebar','scribe::themes.elements.components.field-details','scribe::themes.elements.components.nested-fields',
'scribe::themes.elements.endpoint','scribe::themes.elements.groups','scribe::themes.elements.index','scribe::themes.elements.sidebar','scribe::themes.elements.try_it_out',
'telescope::layout',);
...
'PASSPORT_PASSWORD_GRANT_CLIENT_ID','PASSPORT_PASSWORD_GRANT_CLIENT_SECRET',);
